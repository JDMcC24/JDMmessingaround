...
""" The book uses data for 2002, instead I'm using data for 2023.
If I'm going to draw conclusions which may influence my opinions
about the world, I'd rather keep everything current.
"""


#Commenting out this block of code so not to update data everytime the script is run
